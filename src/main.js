...
import { Game, State } from './game.js?v=4af5982';
import { Stack, MovingBox, Fragments, burnFactor } from './boxes.js?v=4af5982';
import { getAtlas, setAnisotropy } from './textures.js?v=4af5982';
import { Effects } from './effects.js?v=4af5982';
import * as Scenery from './scenery.js?v=4af5982';
import * as Haptics from './haptics.js?v=4af5982';
import * as Audio from './audio.js?v=4af5982';
import * as UI from './ui.js?v=4af5982';
import * as Storage from './storage.js?v=4af5982';
import * as Account from './account.js?v=4af5982';
import * as Rewards from './rewards.js?v=4af5982';
import { share } from './share.js?v=4af5982';
